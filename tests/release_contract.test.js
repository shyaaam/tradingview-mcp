...
test('observer result fixtures satisfy registered output schemas', () => {
  ...
  const fixtures = {
    ...
    chart_runtime_target_lifecycle_trace_v1: {
      ...
      samples: [{
        ...
        runtime_view: {
          ...
          current_url: 'https://www.tradingview.com/chart/x/',
          document_ready_state: 'complete',
          document_title: 'Chart',
          runtime_scheme: 'https',
          chrome_error_page: false,
          ...
          navigation_timing: {
            ...
            duration_ms: 10,
            response_end_ms: 8,
            dom_content_loaded_ms: 9,
            load_event_end_ms: 10,
            redirect_count: 0,
          },
          navigation_disposition: 'DOCUMENT_EXACT',
          navigation_history: {
            available: true,
            entry_count: 1,
            current_index: 0,
            current_entry_url_matches_expected: true,
            current_entry_scheme: 'https',
            current_entry_title: 'Chart',
            current_entry_transition_type: 'typed',
            error: null,
          },
          error: null,
        },
    ...
    chart_saved_layout_identity: {
      ...
      chart_target_id: 'chart-1',
      workspace_layout_id: '8',
      saved_layout_uid: 'chart-id',
      chart_id: 'chart-id',
      canonical_url: 'https://www.tradingview.com/chart/chart-id/',
      pane_count: 1,
      mutations_performed: false,
    },
    tv_observer_capture_candle: {
    ...
    chart_save_existing_capability_probe: {
      ...
      layout_id: 'layout-id',
      pane_count: 1,
      meta_info_type: 'object',
      meta_info_shape: 'object',
      uid_shape: 'string',
      derived_layout_id: 'layout-id',
      chart_available: true,
      save_service_available: true,
      save_existent_chart_type: 'function',
      save_capability_available: true,
      mutations_performed: false,
      persisted_state_authority: 'unavailable',
      persisted_state_note: 'No authoritative persisted parity read is available.',
    },
    chart_save_existing_capability_probe_v2: {
      success: true,
    ...
    chart_save_existing_scoped: {
      ...
      layout_id: 'layout-id',
      pane_count: 1,
      indicator_parity_hash: 'a'.repeat(64),
      saved_layout_id: 'layout-id',
      saved_existing: true,
      mutations_performed: true,
      save_invoked: true,
    ...
    indicator_apply_scoped: {
      ...
      previous_settings: {},
      new_settings: {},
      previous_settings_source: 'absent',
      new_settings_source: 'input_values',
      settings_unavailable_reason: {},
      post_mutation_signature: 'a'.repeat(64),
    ...
    indicator_update_settings_scoped: {
      ...
      previous_settings: {},
      new_settings: {},
      previous_settings_source: 'input_values',
      new_settings_source: 'input_values',
      settings_unavailable_reason: {},
      post_mutation_signature: 'a'.repeat(64),
      post_mutation_indicator: {},
    ...
    indicator_remove_scoped: {
      ...
      new_settings: {},
      previous_settings_source: 'input_values',
      new_settings_source: 'absent',
      settings_unavailable_reason: {},
      post_mutation_signature: 'a'.repeat(64),
      post_mutation_indicator: null,
      post_mutation_indicator_count: 0,
      focus: {},
      message: 'scoped indicator plan item applied',
    },
